...
IMAGE_TAG="${IMAGE_TAG:-agentseek-api-cli-smoke:0.3.2}"
...
positions = [
    ...
    dockerfile.index("agentseek_api-0.3.2-py3-none-any.whl[embedded]"),
...
if importlib.metadata.version("agentseek-api") != "0.3.2":
